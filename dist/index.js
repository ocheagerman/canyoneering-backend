...
var internet = public_ip_1.default.v4();
if (cluster_1.default.isMaster) {
    ...
    server.once('listening', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = log;
                    _b = "Internet: http://";
                    return [4 /*yield*/, internet];
                case 1:
                    _a.apply(void 0, [_b + (_c.sent()) + ":" + PORT]);
                    return [2 /*return*/];
            }
        });
    }); });
